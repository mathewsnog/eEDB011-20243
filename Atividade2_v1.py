...
claimsFile1.columns.values[11] = "quantidade_total_clientes_ccs_scr"
claimsFile1.columns.values[12] = "quantidade_clientes_ccs"
claimsFile1.columns.values[13] = "quantidade_clientes_scr"
...
banksEmployeesClaimsMerge['quantidade_total_clientes_ccs_scr'] = banksEmployeesClaimsMerge['quantidade_total_clientes_ccs_scr'].replace(r'^\s*$', np.nan, regex=True)
banksEmployeesClaimsMerge['quantidade_total_clientes_ccs_scr'] = banksEmployeesClaimsMerge["quantidade_total_clientes_ccs_scr"].fillna(0)
banksEmployeesClaimsMerge['quantidade_clientes_ccs'] = banksEmployeesClaimsMerge['quantidade_clientes_ccs'].replace(r'^\s*$', np.nan, regex=True)
banksEmployeesClaimsMerge['quantidade_clientes_ccs'] = banksEmployeesClaimsMerge["quantidade_clientes_ccs"].fillna(0)
banksEmployeesClaimsMerge['quantidade_clientes_scr'] = banksEmployeesClaimsMerge['quantidade_clientes_scr'].replace(r'^\s*$', np.nan, regex=True)
banksEmployeesClaimsMerge['quantidade_clientes_scr'] = banksEmployeesClaimsMerge["quantidade_clientes_scr"].fillna(0)
banksEmployeesClaimsMerge = banksEmployeesClaimsMerge.astype({"quantidade_total_clientes_ccs_scr": float})
banksEmployeesClaimsMerge = banksEmployeesClaimsMerge.astype({"quantidade_clientes_ccs": float})
banksEmployeesClaimsMerge = banksEmployeesClaimsMerge.astype({"quantidade_clientes_scr": float})

banksEmployeesClaimsMerge.to_csv ("banksEmployeesClaimsMerge.csv", index=False)
banksEmployeesClaimsMerge.to_parquet("C:/Users/anack/OneDrive/Documentos/Pós_eEDB/Visual studio/"+'banksEmployeesClaimsMerge.parquet')
